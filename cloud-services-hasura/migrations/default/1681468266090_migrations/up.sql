...
CREATE TABLE public.review (
    id integer NOT NULL,
    overrall_rating integer,
    cleanness_rating integer,
    title text,
    review_text text,
    company_id integer
);
...
ALTER TABLE ONLY public.review
    ADD CONSTRAINT review_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.companies(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.review
    ADD CONSTRAINT review_id_fkey FOREIGN KEY (id) REFERENCES public.reservations(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.users
